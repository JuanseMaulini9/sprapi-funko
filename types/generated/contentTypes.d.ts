...
export interface ApiFunkoFunko extends Schema.CollectionType {
  ...
  attributes: {
    ...
    slug: Attribute.UID<'api::funko.funko', 'productName'>;
    images: Attribute.Media<'images' | 'files' | 'videos' | 'audios', true>;
    price: Attribute.Decimal;
    stock: Attribute.Integer;
    fav: Attribute.Boolean;
...
export interface ApiSerieSerie extends Schema.CollectionType {
  ...
  attributes: {
    SerieName: Attribute.String;
    slug: Attribute.UID<'api::serie.serie', 'SerieName'>;
    serieImage: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
